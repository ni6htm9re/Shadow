...
Start by opening the file of the bullet that you want to turn green - or if you don't have one yet you can create a new one in `scripts/bullets` and insert this boilerplate:
```lua
